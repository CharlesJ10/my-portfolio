...
public final class FindMeetingQueryTest {
  ...
  @Test
  public void everyAttendeeIsConsideredFirstExercise() {
    // Have each person have different events. We should see two options because each person has
    // split the restricted times.
    //
    // Events  :       |--A--|     |--B--|
  ...
  @Test
  public void everyAttendeeIsConsideredSecondExercise() {
    // Have each person have different events. We should see two options because each person has
    // split the restricted times.
    //
    // Events  :       |--A--|     |--B--|
  ...
  @Test
  public void justEnoughRoomThirdExercise() {
    // Have one person, but make it so that there is just enough room at one point in the day to
    // have the meeting.
    //
    // Events  : |--A--|     |----A----|
  ...
  @Test 
  public void optionalAttendeesFourthExercise() {
    // Have both attendees optional but with several gaps in their schedules
    // Events  :       |--A--|
    //                           |--B--|
    // Day     : |---------------------------|
    // Options : |--1--|     |-2-|     |--3--|
  ...
  @Test 
  public void optionalAttendeesWithNoGapsInScheduleFifthExercise() {
    // Have both attendees optional but with no gaps in their schedules
    // Events  : |------A------|
    //                         |------B------|
    // Day     : |---------------------------|
    // Options : 
